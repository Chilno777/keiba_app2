...
def calculate_scores(
    ...
    prob_main = powered_score / powered_score.sum()
...
# ============================================
# 【26】k と epsilon を探すための補助UI
# - 上位5頭の勝率配分を見やすく表示
# - 今の設定がどんな性格かを表示
# ============================================
st.markdown("## 🎛️ k と epsilon の調整チェック")

if prob_power_k < 1.5:
    k_comment = "k は低めです。指数差をあまり強調しません。"
elif prob_power_k < 2.5:
    k_comment = "k は中くらいです。上位馬を適度に評価します。"
else:
    k_comment = "k は高めです。上位馬にかなり勝率が寄ります。"
